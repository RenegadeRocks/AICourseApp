...
[^12]: Bloomberg reporting via Contrary Research's Cursor business breakdown (late 2025 / early 2026): ~$1B ARR reached November 2025, >1M daily active users, ~50K businesses on the platform — https://research.contrary.com/company/cursor. Secondary aggregator summaries: getlatka https://getlatka.com/companies/cursor.com and Spearhead https://www.spearhead.so/blogs/cursor-by-anysphere-the-fastest-growing-saas-product-ever (treat as synthesis of primary Bloomberg coverage, not independent audit).

[^13]: taptwicedigital, *10 Cursor Statistics (2025): Revenue, Valuation, Competitors, Funding* (citing JetBrains AI Pulse Jan 2026: 69% awareness / 18% work use; State of AI 2025: 82.2% awareness / 33.1% used). https://taptwicedigital.com/stats/cursor
...
[^24]: DigitalApplied, *AI Product Failures 2026: Sora, Humane & Rabbit R1* (Rabbit sold ~100K units on CES demo; voice latency up to 10s; RabbitOS 2 pivot Sep 2025). https://www.digitalapplied.com/blog/ai-product-failures-2026-sora-humane-rabbit-lessons
