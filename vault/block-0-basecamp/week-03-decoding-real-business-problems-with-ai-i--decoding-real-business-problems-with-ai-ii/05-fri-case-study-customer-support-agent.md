...
So if you are an AI-catalyst lead, the support category is not just a vertical — it is the reference implementation. The vendors in it have been shipping to production for two years. They have posted real numbers, eaten real walk-backs, and pivoted real pricing models. You can read their pitch decks, their case studies, their Trustpilot reviews, and the CFO's earnings transcripts side by side. Nowhere else in enterprise AI do you get that density of ground truth.
...
**Shape 2 — Vertically integrated helpdesk + AI layer.** This is Intercom Fin.[^8] Intercom already owned the messaging widget, the inbox, the help-center CMS, the workflow builder, and now they're selling you Fin as the AI layer that sits naturally on top of that stack. The pitch is: if your content is already in Intercom's help center and your routing rules are already in Intercom's workflow engine, Fin will "just work" at 50–60% resolution with a few days of config. You pay $0.99 per resolution on top of the per-seat helpdesk fee.[^8][^9]
...
Decagon's pitch is the opposite of Intercom Fin's: instead of "come into our helpdesk," it is "keep your stack, we are the orchestration brain."[^11] This is a more expensive, slower, higher-touch sell, and the logo list reflects it — Duolingo, Chime, Hertz, Notion, Rippling, Eventbrite, Substack, Riot Games, with Stripe as a reference integration partner.[^11][^12] In June 2025 they raised $131M at a $1.5B valuation, on claimed 100+ enterprise customers added in 2025 alone.[^12]
...
Sierra is the most ambitious architectural bet in the category. Bret Taylor — ex-Google Maps founder, ex-Facebook CTO, ex-Salesforce co-CEO, current OpenAI board chair — launched Sierra in late 2023. By October 2024 Sierra raised $175M at a $4.5B valuation.[^13] By September 2025 they had raised an additional $350M at a **$10B valuation**.[^14] By November 2025 they crossed **$100M ARR**, for a valuation-to-ARR multiple of roughly 100x — indefensible by any normal SaaS benchmark, defensible only if you believe they are building something categorically different.[^15]
...
**The Gartner warning that every vendor deck ignores.** Gartner has projected that **by 2030, the cost per resolution for GenAI customer service may exceed $3** — driven by model-call cost inflation, rising context windows, compliance overhead, guardrail layers, and the labor cost of ongoing eval.[^22] In that scenario, GenAI is more expensive than offshore human agents on a per-unit basis. The implication is not that AI support will fail — it is that the durable moat is not cost arbitrage. It is speed, availability, and consistency. If you are making a 2027–2030 support strategy bet on "AI will always be cheaper than humans," you are betting against a trend line that is already visible.
...
[^12]: Decagon / Business Wire. *Decagon Raises $131M at $1.5B Valuation.* https://www.businesswire.com/news/home/20250623894798/ (Jun 23, 2025).
...
[^14]: TechCrunch. *Bret Taylor's Sierra raises $350M at a $10B valuation.* https://techcrunch.com/2025/09/04/bret-taylors-sierra-raises-350m-at-a-10b-valuation/ (Sep 4, 2025).
[^15]: TechCrunch. *Bret Taylor's Sierra reaches $100M ARR in under two years.* https://techcrunch.com/2025/11/21/bret-taylors-sierra-reaches-100m-arr-in-under-two-years/ (Nov 21, 2025).
...
[^22]: Gartner via CX Today. *AI Customer Service Costs Will Exceed Human Agents by 2030.* https://www.cxtoday.com/contact-center/ai-customer-service-costs-exceed-human-agents-2030-gartner/ (2025).
