...
- A written niche hypothesis on all three axes (vertical × capability × buyer-seniority) from Thursday's [[04-thu-niche-as-a-hypothesis|niche-as-a-hypothesis lesson]]. If you have "AI consultant" as your niche, stop and run Thursday first. This lesson will produce numbers for whatever niche you hand it, and handing it a non-niche produces non-numbers. Saturday's [[06-sat-niche-positioning-and-category-creation|positioning lesson]] turns the validated niche into a statement a buyer can parse in ten seconds.
...
The gating test: commit, in advance, to a decision rule. *"If I cannot secure three LOIs from cold prospects in my claimed niche within 30 days of running this test, I will change the niche or change the approach."* The commit-in-advance part carries the whole test. Without it, operators rationalize post-hoc ("we got two LOIs, that's basically three") and the test stops validating anything. The rule exists to make the signal legible, not to be harsh.
...
**A compliance line you have to internalize before you run any of this at scale.** As of June/July 2026, LinkedIn actively demotes — and can restrict accounts for — AI-generated outreach and the automation tools that mass-produce it, alongside generic AI posts and AI comments.[^19] A July-2026 Pangram study found 41% of LinkedIn long-form already fully machine-written, which is *why* the platform built the enforcement.[^20] So the version of "AI-mediated" this lesson teaches is bounded: **AI does the research and drafts a scaffold; a human writes and sends the actual message in their own voice, one at a time, and never through an automation tool that posts or messages on your behalf.** This is not just risk-avoidance — it is the strategic move of the week. In a channel where a large share of outreach is now detectably machine-made and demoted, the operator who sends a genuinely researched, human-written, checkably-personal message is differentiated *precisely by the slop around them*. Slop-era differentiation is an advantage you buy by refusing to automate the last mile.
...
- **Days 3–5: Outreach (AI-assisted, human-sent).** Reach ~40–60 highly-targeted people with an invitation to a 20-minute async exchange (voice memo, structured email, or a Typeform). Use Claude to do the *research* — pull each prospect's recent public signals, draft a per-person scaffold — but write and send the final message yourself, in your own voice, one at a time. Do **not** wire this into a LinkedIn automation tool or bulk-send an AI-generated template: that is exactly the behavior LinkedIn's 2026 enforcement demotes and restricts, and the reply-rate hit from a message that reads as machine-sent now compounds with the platform penalty. Offer something real in exchange — a 2-page benchmark of their category, a peer-comparison memo, a short diagnostic — not "we'll share what we find." Target 30–40 responses. (Fewer, genuinely-personal, human-sent touches beat a 100-message blast on both ethics and 2026 response rates.)
...
A caveat: AI-mediated scale interviewing *feels* efficient and is easy to botch at the reach step. Claude Code will happily draft scaffolds for a hundred prospects. If the targets are wrong — not on the three-axis niche, or not at the seniority matching your claim — you'll get responses that feel like validation but are actually noise from adjacent categories. And if you let the efficiency tempt you into automating the send, you trade a targeting problem for a platform-enforcement problem. The asymmetry: it's cheaper to over-invest in the targeting upstream — and keep the send human — than to run the whole protocol against the wrong reach or trip the demotion system.
...
> *"Design a 14-day scale-interview protocol for this niche. Draft: (a) 10–12 structured questions covering urgency, authority, budget, priority, fit; (b) a per-prospect research brief and an outreach-message scaffold (which I will personalize and send myself, in my own voice) inviting a 20-minute asynchronous exchange, with a real-value exchange offer appropriate for the niche; (c) a synthesis rubric for categorizing responses by urgency level, budget source, and priority; (d) an LOI opener script for the 5 respondents most likely to convert. For each piece, explain the design choice."*

Personalize and send each message yourself — target ~40–60 human-sent touches, accept 30–40 responses. Do not bulk-send AI-generated templates or route sends through a LinkedIn automation tool; that is the behavior the platform's 2026 enforcement demotes, and it also tanks reply rates. Direct Claude Code to synthesize at Day 12.
...
[^19]: LinkedIn's June/July 2026 anti-AI-slop enforcement — demotes generic AI-generated posts, AI comments, and the automation tools that mass-produce AI outreach (and can restrict accounts for repeated violations); AI-*assisted* content that a human personalizes remains welcome. https://thenextweb.com/news/linkedin-ai-slop-crackdown-generic-content ; https://www.entrepreneur.com/business-news/linkedin-is-fighting-back-against-ai-slop-and-ai-comments (verified 2026-07-17).

[^20]: Pangram Labs, *AI Content Is Everywhere on Social Media, Especially LinkedIn* (July 2026) — 41% of LinkedIn long-form fully machine-generated; the quantitative floor under the platform's enforcement. https://www.pangram.com/blog/ai-in-your-feed (verified 2026-07-17).
