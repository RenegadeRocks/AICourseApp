...
| Tue | Agent architectures — Anthropic's five workflow patterns vs autonomous, MCP as the connector layer (first taught in [[01-mon-mcp-as-a-protocol]]), tool-calling reliability against BFCL and τ-bench | Deep-dive + tool-schema build |
...
- **Both have a 2025–26 controversy you have to take a position on.** *Is 11x's AI-SDR category real pipeline or inbox-flooding theatre?* *Does the 1M-token window — now standard on Claude Fable 5, Claude Sonnet 5, Gemini 3, and GPT-5.5 — kill RAG?* Neither is decided. This week arms you to argue either side with named operator numbers.
...
4. **Operator-level specifics with numbers.** 11x's $14M claimed / $3M real ARR and 70–80% churn;[^1] Anthropic's Contextual Retrieval failure-rate reductions (taught canonically in [[03-wed-rag-as-a-system]] — Thursday builds on them rather than re-deriving them);[^7] Nurture Boss going 33%→95% answer quality over three rubric iterations;[^6] τ-bench pass^8 below 25% even for frontier models.[^10]
5. **A reviewer lens with named disagreements.** Every lesson names specific paragraphs a Karpathy, a Chip Huyen, a Jerry Liu, a Jason Liu, a Simon Willison, a Harrison Chase, a Boris Cherny, a Lilian Weng, a Douwe Kiela, or a Ben Hylak would push back on — and what they'd argue instead.
...
[^4]: Anthropic (2026-03-13). *Claude Opus 4.6 / Sonnet 4.6 1M-context GA.* — 1M tokens at standard pricing. As of July 2026, 1M context is standard across the current lineup (Claude Fable 5, Opus 4.8, Sonnet 5); see https://platform.claude.com/docs/en/about-claude/models/overview. Verified 2026-07-17.
[^5]: Anthropic (2024-12-19). *Building Effective Agents.* Schluntz & Zhang — five workflow patterns + the autonomous edge, with the "simplest solution possible" directive. Sierra update: $950M Series E at $15.8B post-money, $150M+ ARR in eight quarters (TechCrunch, 2026-05-04, https://techcrunch.com/2026/05/04/sierra-raises-950m-as-the-race-to-own-enterprise-ai-gets-serious/). Verified 2026-07-17.
