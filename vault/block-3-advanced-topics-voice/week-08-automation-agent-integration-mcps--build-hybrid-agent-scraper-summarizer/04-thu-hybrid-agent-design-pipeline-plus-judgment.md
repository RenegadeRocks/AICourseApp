...
- **Model tiering.** Relevance judging (stage 4) is a cheap classification: run it on the cheapest capable tier (Haiku-class or Sonnet 5 at $2/$10 intro). Synthesis (stage 5) is where quality shows, so spend the better model there. Don't pay flagship rates to decide "is this on-topic."[^6][^7]
